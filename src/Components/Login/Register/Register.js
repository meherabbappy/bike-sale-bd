...
import registration from '../../../images/bike6.jpg'
                ...
                <Grid item sx={{ mt: 8 }} xs={12} md={6}>
                    ...
                    {!isLoading ? <form onSubmit={handleLoginSubmit}>
                        ...
                        <TextField sx={{ width: "75%", m: 1 }} id="standard-basic"
                            ...
                            onBlur={handleonBlur}
                        />
                        <Button className="bbbb" sx={{ width: "75%", m: 1 }} variant='contained' type="submit"> Register</Button>
                        <NavLink
                            style={{ textDecoration: 'none' }}
                            to='/login'>
                            <Button sx={{ color: "red" }} variant="text">Already Registered? please Login</Button>
                        </NavLink>
                    </form> :
                        <CircularProgress />
